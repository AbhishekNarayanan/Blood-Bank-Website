...
<img src="donor_6jpg.jpg" width="70%" height="400px" style="float:left;">
<img src="donate_7.jpg" width="30%" height="400px" style="float:right;">
<h3>Register as a Donor Now :-</h3>
<div class="p"><form action="save_data_donor.php" method="post">
  	<fieldset>
    ...
    <input type="tel" id="Residence" name="residence" placeholder="Your address" style="width:29.2%;">
    <label for="Office"><span style="display:inline-block; width: 30px;"></span>Office Address</label>
    <input type="tel" id="Office" name="office" placeholder="Your address" style="width:27.5%;">
  	</fieldset>
  <br>
	...
	<p>
		You will receive an Call on your mobile when there is a request for your blood type within your city.
	</p>
