...
<img src="volunteers-needed.jpg" width="100%" height="400px">
<h3>Register as a Volunteer Now :-</h3>
<div class="p">
   <form action="save_data_volunteer.php" method="post">
  	<fieldset>
  ...
  <br>
    ...
    <p>
    	You will receive an alert on your mobile when there is a need for your help.
    </p>
	<input type="checkbox" name="call" value="call alert">Call Alert<br>
	<p>
		You will receive a Call on your mobile when there is a need for your help.
	</p>
